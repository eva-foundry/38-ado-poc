...
# [38-ado-poc] Agent Wake-Up Checkpoint
...
## Authoritative Queries
    ...
    $project = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/projects/38-ado-poc"
    $projectWork = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/project_work/?project_id=38-ado-poc"
    $sprints = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/sprints/?project_id=38-ado-poc"
    $evidence = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/evidence/?project_id=38-ado-poc"
