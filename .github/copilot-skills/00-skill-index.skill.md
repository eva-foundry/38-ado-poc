...
# Skill Index -- ADO Command Center

> This is the skills menu for 38-ado-poc.
...
**Goal**: Orchestration hub: reads ADO board, dispatches DPDCA runners across 18 projects, feeds 39-ado-dashboard
**37-data-model record**: `GET /model/projects/38-ado-poc`
